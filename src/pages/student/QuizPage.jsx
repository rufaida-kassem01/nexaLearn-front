...
const QuizPage = () => {
  ...
  const pollForResult = useCallback(async () => {
    ...
    try {
      const data = await assessmentService.getAttemptResult(lessonId, attempt.id);
