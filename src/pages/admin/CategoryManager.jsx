...
const INIT_FORM = { name: "", slug: "", parentId: "", description: "" };

const CategoryForm = ({ initial, parents, onSubmit, onCancel, loading }) => {
...
const CategoryNode = ({ category, onEdit, onDelete, onAddChild, flatParents }) => {
...
const CategoryManager = () => {
  ...
  const [formInitial, setFormInitial] = useState(INIT_FORM);
