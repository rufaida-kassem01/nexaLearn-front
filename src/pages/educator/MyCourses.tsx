...
const MyCourses = () => {
  ...
  const [deleteConfirm, setDeleteConfirm] = useState<DeleteConfirmState>({ isOpen: false, courseId: null, courseTitle: "" });
  ...
  const openDeleteConfirm = (courseId: string, courseTitle: string) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      addToast(err instanceof Error ? err.message : "Failed to delete course.", "error");
    } finally {
      setDeleting(false);
    }
  };
